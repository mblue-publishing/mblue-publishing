...
> The full version of this accounting, including the credential pathways state by state, the year-one and year-three income comparisons across all four paths, and the 90-day sequences that get each one moving while you're still working full-time, is in my book, The Trade-Out Plan: A Tradesperson's Step-by-Step Guide to Building Your Exit Before the Job Builds It for You. I've been through three of these four paths directly and the fourth alongside a dozen tradespeople I've helped. None of it is theoretical. You can find the book on [Amazon](https://www.amazon.com/dp/B0H1YGZW2Z).
