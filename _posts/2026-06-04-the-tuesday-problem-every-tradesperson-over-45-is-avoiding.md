...
> I spent the 5 years after my own Tuesday building the map I couldn't find in that waiting room: the specific paths, the real income numbers in year one and year three, the credential requirements state by state, and the 90-day sequences that get each path moving while you're still on the tools. It's all in my book, The Trade-Out Plan: A Tradesperson's Step-by-Step Guide to Building Your Exit Before the Job Builds It for You. If the number you just wrote down got your attention, the book is the next step. You can find it on [Amazon](https://www.amazon.com/dp/B0H1YGZW2Z).
